PROGRAM uquantchem
      ...
      CALL readin(CORRLEVEL,NATOMS,NLINES,ATOMICNUMBERS,APOS,Ne,MULTIPLICITY,Tol,WRITECICOEF,WRITEDENS,WHOMOLUMO,MESH,LIMITS,LEXCSP,NEEXC,ENEXCM,SPINCONSERVE,RESTRICT,APPROXEE, &
      ...
      ENDIF
        ...
        IF ( RELAXN .AND. .not. MOLDYN ) THEN
                ...
                IF ( RELALGO .EQ. 2 ) THEN
                        CALL relax(gradS,gradT,gradV,gradIntsv,S,H0,Intsv,NB,NRED,Ne,MULTIPLICITY,nucE,Tol,FTol,MIX,DIISORD,DIISSTART,NATOMS,NSTEPS,NLSPOINTS,PORDER,DR,BAS,ATOMS,& 
                ...
                IF (RELALGO .EQ. 1 ) THEN
                        CALL relaxf(gradS,gradT,gradV,gradIntsv,S,H0,Intsv,NB,NRED,Ne,MULTIPLICITY,nucE,Tol,FTol,MIX,DIISORD,DIISSTART,NATOMS,NSTEPS,DR,BAS,ATOMS,& 
                                        & APPROXEE,CORRLEVEL,PRYSR,PRYSW,PULAY,LORDER,CGORDER,LQ,CGQ,EETOL,ETEMP)
                ENDIF
        ENDIF
        ...
        IF ( MOLDYN ) THEN
                ...
                IF ( SOFTSTART ) THEN
                  CALL moleculardynamicssoft(gradS,gradT,gradV,gradIntsv,S,H0,Intsv,NB,NRED,Ne,MULTIPLICITY,nucE,Tol,MIX,DIISORD,DIISSTART,NATOMS,NTIMESTEPS,TIMESTEP,BAS,ATOMS,APPROXEE,CORRLEVEL,PRYSR,PRYSW,&
                ...
                ELSE
                  CALL moleculardynamics(gradS,gradT,gradV,gradIntsv,S,H0,Intsv,NB,NRED,Ne,MULTIPLICITY,nucE,Tol,MIX,DIISORD,DIISSTART,NATOMS,NTIMESTEPS,TIMESTEP,BAS,ATOMS,APPROXEE,CORRLEVEL,PRYSR,PRYSW,&
