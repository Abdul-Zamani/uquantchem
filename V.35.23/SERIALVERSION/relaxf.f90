SUBROUTINE relaxf(gradS,gradT,gradV,gradIntsv,S,H0,Intsv,NB,NRED,Ne,MULTIPLICITY,BSURHF,nucE,Tol,FTol,MIX,DIISORD,DIISSTART,NATOMS,NSTEPS,DR,BAS,ATOMS,APPROXEE,CORRLEVEL,PRYSR,PRYSW,& 
        ...
        INTEGER, INTENT(IN) :: NB,Ne,MULTIPLICITY,NATOMS,NSTEPS,DIISORD,DIISSTART,PULAY
        ...
        LOGICAL :: CFORCE,SCRATCH,LSEARCH,ST,SLUT,BSURHF 
