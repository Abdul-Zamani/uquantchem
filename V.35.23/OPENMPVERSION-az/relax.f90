SUBROUTINE relax(gradS,gradT,gradV,gradIntsv,S,H0,Intsv,NB,NRED,Ne,MULTIPLICITY,BSURHF,nucE,Tol,FTol,MIX,DIISORD,DIISSTART,NATOMS,NSTEPS,&
        ...
        INTEGER, INTENT(IN) :: NB,Ne,multiplicity,NATOMS,NSTEPS,DIISORD,DIISSTART,NLSPOINTS,PORDER,PULAY,EDIR,NBAUX,LIMPRECALC
        ...
        LOGICAL :: CFORCE,SCRATCH,LSEARCH,ST,RIAPPROXX,SLUTA,bsurhf
