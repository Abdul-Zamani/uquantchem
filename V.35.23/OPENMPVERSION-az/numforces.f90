SUBROUTINE numforce(S,H0,Intsv,NB,NRED,Ne,MULTIPLICITY,BSURHF,Tol,FTol,MIX,DIISORD,DIISSTART,NATOMS,DRF,BAS,ATOMS,APPROXEE,CORRLEVEL,PRYSR,PRYSW, &
        ...
        INTEGER, INTENT(IN) :: NB,Ne,multiplicity,NATOMS,DIISORD,DIISSTART,NEPERIOD,EDIR,NBAUX
        ...
        LOGICAL :: SCRATCH,LSEARCH,bsurhf
